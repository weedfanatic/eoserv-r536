...
/* $Id: guild.cpp 534 2016-06-17 06:58:15Z Sausage $
...
void Guild::AddMember(Character *joined, Character *recruiter, bool alert, int rank)
{
	...
	{
		PacketBuilder builder(PACKET_GUILD, PACKET_AGREE, 9 + this->name.length() + joined->guild_rank_string.length()); //25
